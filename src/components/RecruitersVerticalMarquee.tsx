...
export default function RecruitersVerticalMarquee() {
  ...
  return (
    <section id="placements" className="py-20 bg-white border-t border-zinc-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center mb-16">
          ...
          <div className="lg:col-span-6">
            ...
            >
              Industry Collaborations & Career Success
            </h2>

            <p 
              style={{ fontSize: "14px", lineHeight: "26px" }}
              className="font-ranade font-light text-zinc-600 mt-4 max-w-xl"
            >
              Our strategic industry collaborations and partnerships provide students with real-world exposure through internships, live projects, expert mentoring, technical workshops, and placement opportunities with leading technology companies.
            </p>
          </div>

          <div className="lg:col-span-6">
            <h3 className="font-excon font-semibold text-[#0B1E33] text-xs uppercase tracking-widest mb-4 flex items-center gap-2">
      ...
      {/* Clean, Full-Width Horizontal Infinite Scroll in Two Rows */}
      <div className="relative w-full overflow-hidden select-none py-6 pause-marquee flex flex-col gap-6">
        
        {/* Edge Left/Right Soft Overlay Fades (blends seamlessly into white bg) */}
